![header](https://capsule-render.vercel.app/api?type=cylinder&height=200&color=gradient&text=DoxB`s%20GitHub!&animation=fadeIn&reversal=false&fontSize=60)

## ✈️ Career
`2025.02 ~ 2025.06` 🎓 고려대학교 지능정보 SW 아카데미 6기 수료- AI 교육과정<br>
`2024.07 ~ 2024.12` 🎓 우리에프아이에스 아카데미 3기 수료 - AI 엔지니어링 과정<br>
`2023.06 ~ 2024.02` 🖥️ 에이뉴트 매니저 - AI 개발<br>
`2023.03 ~ 2023.05` 🖥️ 어노테이션에이아이 인턴 - AI 개발<br>
`2016.03 ~ 2024.02` 🎓 경기대학교 컴퓨터공학부 졸업

## 📊 Project
🛠️ `2025.12.01 ~ (진행중)` 모의투자 플랫폼 (개인)
[🪧 바로가기](https://github.com/DoxB/Crypto-Trading)<br>
...
[🪧 바로가기](https://www.aihub.or.kr/aihubdata/data/view.do?currMenutopMenuaihubDataSedatadataSetSn71691)
...
[![My Skills](https://skillicons.dev/icons?i=java,python,js,spring,fastapi,react,mysql,elasticsearch,pytorch&theme=light)](https://skillicons.dev)

**🛠️ Infra and Tools**

[![My Skills](https://skillicons.dev/icons?i=docker,linux,vscode,eclipse&theme=light)](https://skillicons.dev)
